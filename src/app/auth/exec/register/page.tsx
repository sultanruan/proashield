...
export default function ExecRegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await supabase.auth.signUp({
      ...
      password,
      options: {
        data: { full_name: fullName, user_type: 'exec' },
        emailRedirectTo: `${window.location.origin}/onboarding/exec`,
      },
    })
        ...
        >
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-[#52525B] max-w-sm">
              ...
              Click it to activate your executive account.
            </p>
          </div>
        </motion.div>
      </main>
  ...
  return (
    <AuthLayout
      ...
      subtitle="Set up your executive outreach firewall."
    >
